...
st.markdown(
    "Use this page to submit prediction files and metrics. Files will be saved locally to `submissions/` and can be reviewed by maintainers."
)
...
if st.button("Submit"):
    if not username:
        ...
        st.markdown(
            "Maintainers can review the `submissions/` folder and optionally add entries"
            " to a leaderboard or create releases."
        )
